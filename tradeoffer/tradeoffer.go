...
const (
	...
	TradeOfferState_Active                   TradeOfferState = 2  // This trade offer has been sent, neither party has acted on it yet.
	TradeOfferState_Accepted                 TradeOfferState = 3  // The trade offer was accepted by the recipient and items were exchanged.
	TradeOfferState_Countered                TradeOfferState = 4  // The recipient made a counter offer
	TradeOfferState_Expired                  TradeOfferState = 5  // The trade offer was not accepted before the expiration date
	TradeOfferState_Canceled                 TradeOfferState = 6  // The sender cancelled the offer
	TradeOfferState_Declined                 TradeOfferState = 7  // The recipient declined the offer
	TradeOfferState_InvalidItems             TradeOfferState = 8  // Some of the items in the offer are no longer available (indicated by the missing flag in the output)
	TradeOfferState_CreatedNeedsConfirmation TradeOfferState = 9  // The offer hasn't been sent yet and is awaiting email/mobile confirmation. The offer is only visible to the sender.
	TradeOfferState_CanceledBySecondFactor   TradeOfferState = 10 // Either party canceled the offer via email/mobile. The offer is visible to both parties, even if the sender canceled it before it was sent.
	TradeOfferState_InEscrow                 TradeOfferState = 11 // The trade has been placed on hold. The items involved in the trade have all been removed from both parties' inventories and will be automatically delivered in the future.
)
...
const (
	...
	TradeOfferConfirmationMethod_Email     TradeOfferConfirmationMethod = 1
	TradeOfferConfirmationMethod_MobileApp TradeOfferConfirmationMethod = 2
)
